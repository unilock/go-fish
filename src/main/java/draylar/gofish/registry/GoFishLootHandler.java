        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if(LootTables.FISHING_FISH_GAMEPLAY.equals(id) && source.isBuiltin() && !hasModifiedFishPool) {
                ...
                tableBuilder.modifyPools(lpb -> {
                    ...
                    lpb.with(ItemEntry.builder(GoFishItems.CLOUDY_CRAB).weight(50).conditionally(LocationCheckLootCondition.builder(LocationPredicate.Builder.create().y(NumberRange.FloatRange.atLeast(150)))).build());
